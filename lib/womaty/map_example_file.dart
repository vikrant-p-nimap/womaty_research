    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          //   final lat = 18.9582; // _rnd.nextDouble() * 20 + 30;
          //   final lng = 72.8321; // _rnd.nextDouble() * 20 + 125;
          //   param.add(LatLng(18.9952463, 72.8245883));
          // }

          param.add(LatLng(18.9952463, 72.8245883));

          _mapController.toScreenLocationBatch(param).then((value) {
            final point = Point<double>(value[0].x as double, value[0].y as double);
            _addMarker(point, param[0]);
            // for (var i = 0; i < randomMarkerNum; i++) {
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
        ...
        child: RotationTransition(
            turns: _animation,
            child: Image.asset('assets/marker_pin_avatar.png', height: _iconSize)));
  }
